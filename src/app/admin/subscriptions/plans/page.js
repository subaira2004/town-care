...
export default function AdminSubscriptionPlansPage() {
  ...
  const {
    ...
    mutate,
  } = useSWR("admin-subscription-plans", async () => {
  ...
  const handleDeletePlan = async (id) => {
    if (!confirm("Are you sure? This will affect all pharmacies on this plan."))
      return;
    setLoading(true);
    const { error } = await supabase
      .from("subscription_plans")
        ...
        {plans.map((plan) => (
          ...
          >
            ...
            <div style={{ marginBottom: "1.5rem" }}>
              ...
              {plan.price_yearly > 0 && (
                <div
                  style={{ fontSize: "0.875rem", color: "var(--secondary)" }}
                >
              ...
              >
                ...
                >
                  ...
                  <span style={{ fontWeight: "600" }}>
                    {plan.max_tokens_per_month || "Unlimited"}
                  </span>
                </div>
                <div
                  style={{ display: "flex", justifyContent: "space-between" }}
        ...
        >
          ...
          >
            ...
            <p style={{ marginBottom: "1.5rem", color: "var(--text-muted)" }}>
              Editing: <strong>{editingPlan?.name}</strong>
            </p>
